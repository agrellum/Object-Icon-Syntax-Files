...
" Object Icon	2021 Jan 14 Jason Martin <agrellum@gmail.com>
...
syn keyword  iconFunction   abs acos any args asin atan back bal
syn keyword  iconFunction   callout center char chdir classof clear close coact cocopy cofail collect copy
syn keyword  iconFunction   cos cset delay delete detab display dtor
syn keyword  iconFunction   entab errorclear exit exp fatalerr find flush function
syn keyword  iconFunction   get getch getche getenv iand icom image
syn keyword  iconFunction   insert integer ior is ishift ixor kbhit key keyof keyval
syn keyword  iconFunction   left list loadfunc log many map match max
syn keyword  iconFunction   member min move name numeric open ord pop
...
syn keyword  iconFunction   runerr save seek seq serial set sin sort
syn keyword  iconFunction   sortf sqrt stop string syserr system tab table
syn keyword  iconFunction   tan text trim type uchar ucs upto variable weakref weakrefval where write writes

" Keywords
syn match iconKeyword "&allocated"
syn match iconKeyword "&ascii"
syn match iconKeyword "&break"
...
syn match iconKeyword "&errorcoexpr"
...
syn match iconKeyword "&maxlevel"
syn match iconKeyword "&no"
...
syn match iconKeyword "&uset"
syn match iconKeyword "&version"
syn match iconKeyword "&why"
syn match iconKeyword "&yes"
...
syn keyword iconReserved then to unless until while
syn keyword iconReserved class import package succeed

" Storage class reserved words
syn keyword	iconStorageClass	global static local record
syn keyword	iconStorageClass	abstract const final
syn keyword	iconStorageClass	invocable native optional
syn keyword	iconStorageClass	override private protected
syn keyword	iconStorageClass	public readable

syn keyword	iconTodo	contained TODO FIXME XXX BUG

" String and Character constants
" Highlight special characters (those which have a backslash) differently
syn match iconSpecial contained "\\x\x\{2}\|\\u\x\{4}\|\\U\x\{6}\|\\\o\{3\}\|\\[bdeflnrtvN\"\'\\]\|\\^c\|\\$"
...
"syn match	iconSpecialCharacter "'\\[bdeflnrtvN]'"
...
syn region	iconPreCondit start="^\s*$\s*\(error\>\|encoding\>\|elsif\>\|uload\>\|load\>\|include\>\|line\>\|if\>\|ifdef\>\|ifndef\>\|elif\>\|else\>\|endif\>\)" skip="\\$" end="$" contains=iconComment,iconString,iconCharacter,iconNumber,iconCommentError,iconSpaceError
